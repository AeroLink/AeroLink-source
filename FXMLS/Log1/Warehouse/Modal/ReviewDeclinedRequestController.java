 ...
 * @author Crenz
 */
public class ReviewDeclinedRequestController implements Initializable {
    ...
    public void populateFields(Log1_WarehouseRequestItemClassfiles reviewRequest) {
        ...
        reqDetails.add("Declined by:  "+reviewRequest.getRequestApprover());
        reqDetails.add("Reason of Decline:  "+reviewRequest.getApprovedRequestRemarks());

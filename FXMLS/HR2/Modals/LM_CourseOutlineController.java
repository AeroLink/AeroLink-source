...
public class LM_CourseOutlineController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        txt_path.textProperty().addListener((observable) -> {
        ...
        lbl_job_title.setText("JOB00" + HR2_LM_CourseOutlineModal.cid + " - " + HR2_LM_CourseOutlineModal.jid);
        DisplayFilesInTable();
        FilesTable();
        btn_save.setDisable(true);
    ...
    public void DisplayFilesInTable() {
        ...
        try {
            //tbl courses
            HR2_CourseOutline c = new HR2_CourseOutline();
            ...
            CompletableFuture.supplyAsync(() -> {
                while (Session.CurrentRoute.equals("learning_management")) {
                    ...
                    if (DummyCount != GlobalCount) {
                        ...
                        List courses = c.join(Model.JOIN.INNER, "aerolink.tbl_hr2_courses", "course_id", "co", "=", "course_id")
                                .join(Model.JOIN.INNER, "aerolink.tbl_hr4_jobs", "job_id", "=", "co", "job_id",true)
                                .where(new Object[][]{{"aerolink.tbl_hr4_jobs.title", "=", HR2_LM_CourseOutlineModal.jid }, {"aerolink.tbl_hr2_course_outline.isDeleted", "<>", "1"}})
                                .get("aerolink.tbl_hr2_course_outline.course_id","aerolink.tbl_hr2_course_outline.uploaded_file");
    ...
    public void Save() {
        ...
        try {
            ...
            String[][] cm_data
                    = {
                         {"course_id", HR2_LM_CourseOutlineModal.cid},

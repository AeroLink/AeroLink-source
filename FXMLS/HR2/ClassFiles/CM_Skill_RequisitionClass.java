...
public class CM_Skill_RequisitionClass {
    ...
    public SimpleStringProperty sr_id, dept_name, title, req_status;
    
    public CM_Skill_RequisitionClass(String sr_id, String dept_name, String title, String req_status)
    {

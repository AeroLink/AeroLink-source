...
public class SOPviewPackageInspectionController implements Initializable {
    ...
    public void GenerateTC() {
        ...
        TableColumn<SOPTable_package_inspect, String> book_id = new TableColumn<>("PACKAGE NUMBER");
        TableColumn<SOPTable_package_inspect, String> status = new TableColumn<>("STATUS");
        TableColumn<SOPTable_package_inspect, String> created_at = new TableColumn<>("DATE");
        book_id.setCellValueFactory((TableColumn.CellDataFeatures<SOPTable_package_inspect, String> param) -> param.getValue().book_id);
        status.setCellValueFactory((TableColumn.CellDataFeatures<SOPTable_package_inspect, String> param) -> param.getValue().status);
        created_at.setCellValueFactory((TableColumn.CellDataFeatures<SOPTable_package_inspect, String> param) -> param.getValue().created_at);
    ...
    public void AddTable(List rs) {
        ...
        for (Object row : rs) {
            ...
            spi.add(new SOPTable_package_inspect(book_id, status, created_at));
        }
    }
